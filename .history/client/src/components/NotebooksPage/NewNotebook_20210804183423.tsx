...
function resultsExpand({ children, eventKey }) {
  const decoratedOnClick = useAccordionButton(eventKey, () => {});

  return <a onClick={decoratedOnClick}>{children}</a>;
}
...
const NewNotebook: FunctionComponent = () => {
  ...
  const accordionHandler = useAccordionButton();
